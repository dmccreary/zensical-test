...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| Glossary | :white_check_mark: | Medium | 75 terms with ISO 11179 compliant definitions |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| MicroSims (interactive simulations) | :white_check_mark: | High | 3 browser-based apps for hands-on learning |
...
| Concept list (~200-300 concepts) | :x: | High | Every topic students need to learn, extracted with AI help |
| Learning graph CSV | :x: | High | Spreadsheet defining which concepts depend on others |
...
| Concept taxonomy classification | :x: | Medium | Grouping concepts into categories |
| Quality metrics report | :x: | Low | Statistics about graph completeness and structure |
...
| Feature | Status | Effort | Notes |
|---------|--------|--------|-------|
| Chapter content | :x: | Very High | 0 chapters with full text, examples, and exercises |
